...
<?php if (have_posts()) : ?>
    <?php while (have_posts()) : ?>
        ...
        <?php $content_has_own_title = has_shortcode($page_content, 'ssf_application_form') || has_shortcode($page_content, 'ssf_inspector_portal') || has_shortcode($page_content, 'ssf_member_portal_annual_meeting') || has_shortcode($page_content, 'ssf_member_portal_annual_meetings') || has_shortcode($page_content, 'ssf_member_portal_annual_meeting_registration') || has_shortcode($page_content, 'ssf_member_portal_motion_hub') || has_shortcode($page_content, 'ssf_member_portal_motions') || has_shortcode($page_content, 'ssf_member_portal_motion_status'); ?>
