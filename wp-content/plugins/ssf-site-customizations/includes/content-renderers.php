...
function ssf_site_editorial_home_shortcode(): string
{
    ...
    <?php do_action('ssf_home_after_hero'); ?>
    ...
    <section class="ssf-section"><div class="ssf-wrap"><h2><?php echo esc_html($home['choices_title']); ?></h2><div class="ssf-home-choices"><?php echo ssf_site_home_choice($home['choice_application_title'], $home['choice_application_text'], ssf_site_content_url($home['choice_application_url'])); ?><?php echo ssf_site_home_choice($home['choice_member_title'], $home['choice_member_text'], ssf_site_content_url($home['choice_member_url'])); ?><?php echo ssf_site_home_choice($home['choice_contact_title'], $home['choice_contact_text'], ssf_site_content_url($home['choice_contact_url'])); ?></div></div></section>
    <section class="ssf-section ssf-section--blue"><div class="ssf-wrap"><h2><?php echo esc_html($home['about_title']); ?></h2><?php echo wp_kses_post(ssf_site_content_text($home['about_text'])); ?><div class="ssf-home-values"><?php echo ssf_site_home_value($home['value_one_title'], $home['value_one_text']); ?><?php echo ssf_site_home_value($home['value_two_title'], $home['value_two_text']); ?><?php echo ssf_site_home_value($home['value_three_title'], $home['value_three_text']); ?></div></div></section>
    ...
    <?php if (ssf_site_get_latest_newsletter()) : ?><section class="ssf-section ssf-section--gold"><div class="ssf-wrap"><h2>Senaste nyhetsbrevet</h2><?php echo do_shortcode('[ssf_latest_newsletter]'); ?></div></section><?php endif; ?>
...
function ssf_site_editorial_contact_shortcode(): string
{
    ...
    <section class="ssf-page-content">
        ...
        <?php echo ssf_site_contact_form_markup((string) $contact['form_title']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
    </section>
    <?php
    return (string) ob_get_clean();
}
