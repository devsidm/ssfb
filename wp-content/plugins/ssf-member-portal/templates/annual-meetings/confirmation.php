...
<section class="ssf-am-page ssf-am-confirmation" aria-labelledby="ssf-am-confirmation-heading">
    ...
    <section class="ssf-am-confirmation__receipt" aria-labelledby="ssf-am-confirmation-summary">
        ...
        <dl class="ssf-am-summary"><div><dt><?php esc_html_e('Namn', 'ssf-member-portal'); ?></dt><dd><?php echo esc_html($registration['first_name'] . ' ' . $registration['last_name']); ?></dd></div><div><dt><?php esc_html_e('Ditt deltagande', 'ssf-member-portal'); ?></dt><dd><?php echo $registration['program_labels'] ? esc_html(implode(', ', $registration['program_labels'])) : esc_html__('Inga valda alternativ', 'ssf-member-portal'); ?></dd></div><?php if ($registration['food']) : ?><div><dt><?php esc_html_e('Mat', 'ssf-member-portal'); ?></dt><dd><?php echo esc_html(implode(', ', $registration['food'])); ?></dd></div><?php endif; ?></dl>
    </section>
