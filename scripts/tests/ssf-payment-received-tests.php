...
check('Betalning markerad som mottagen.' === $history[0]['message'], 'Received payment history missing.');
check('Betalning markerad som ej mottagen.' === $history[1]['message'], 'Cleared payment history missing.');
